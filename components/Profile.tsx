...
const Profile: NextPage = () => {
  const my_intro:my_profile[]=[
    ...
    },
    {
      question:"大学",
      answer:'東京理科大学',
      detail:"留年する人が多いで有名な大学。レポートの量が多く、テストの難易度も高め。友達がいなく、勉強をさぼっているとほぼ留年する。陰キャが多いがたまに陽キャ現る。女子は少なく、彼女を作りたいなら早めにアタックしないと手遅れになる(薬学部は違うらしい)。理不尽な教授が多いｗ"
    },
    {
      question:"学部学科",
      answer:'工学部情報工学科',
      detail:"人工知能や数理最適化、画像処理などを学んでいく。プログラミングを学ぶと思いきやほとんどが数学。。あと、女子が少ないので注意！",
    },
    {
      question:"中学部活動",
      answer:'サッカー部',
